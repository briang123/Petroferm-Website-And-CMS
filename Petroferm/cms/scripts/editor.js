...
function InnovaEditor(oName)
  ...
  // This is the page to point to the list of Petroferm pages (by BU) - 12/16/06 KR 
  this.cmdInternalLink= "windowOpen('InternalLink.aspx',500,272);";//needs ;
  ...
  this.spellCheckMode="NetSpell";//ieSpell
    ...
    switch(sButtonName)
      ...
      case "SpellCheck":
        if(this.btnSpellCheck)
          ...
          //alert(checkSpellingById('idContent"+this.oName+"'));
