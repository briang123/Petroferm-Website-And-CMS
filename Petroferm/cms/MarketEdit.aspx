<%@ Page Language="VB" MasterPageFile="~/cms/MasterCMS.master" AutoEventWireup="false" CodeFile="MarketEdit.aspx.vb" Inherits="CmsMarketEdit" title="Untitled Page" Theme="CMS_Theme" StylesheetTheme="CMS_Theme" %>
    ...
    <table id="TABLE1" style="width: 527px">
        <tr>
            ...
            <td style="width: 352px;">
                <asp:TextBox ID="txtMarketName" runat="server" Width="209px" MaxLength="100"></asp:TextBox>
                <asp:RequiredFieldValidator ID="vldNameRequired" runat="server" ControlToValidate="txtMarketName"
        ...
        <tr style="color: #000000">
            <td class="formFieldLabel" style="width: 120px;">
                Order</td>
            <td style="width: 352px;">
                <asp:TextBox ID="txtOrder" runat="server" MaxLength="2" Width="37px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="vldOrderRequired" runat="server" ControlToValidate="txtOrder"
                    Display="Dynamic" ErrorMessage="Order is required."></asp:RequiredFieldValidator>
                <asp:CompareValidator ID="vldOrderNumeric" runat="server" ControlToValidate="txtOrder"
                    Display="Dynamic" ErrorMessage="Order must be numeric." Operator="DataTypeCheck"
        ...
        <tr>
            <td class="formFieldLabel" style="width: 120px; height: 37px">
                Expiration Date</td>
            ...
            <asp:TextBox ID="hidMarketID" runat="server" Visible="False" Width="10px"></asp:TextBox>
