<%@ Page Language="VB" MasterPageFile="~/cms/MasterCMS.master" AutoEventWireup="false" CodeFile="DeploymentJobEdit.aspx.vb" Inherits="CmsDeploymentJobEdit" title="Untitled Page" Theme="CMS_Theme" StylesheetTheme="CMS_Theme" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="phMain" Runat="Server">
    ...
    <table id="TABLE1" style="width: 600px">
        <tr>
            <td style="width: 120px;" class="formFieldLabel">
                Job Name</td>
            <td style="width: 372px;">
                <asp:TextBox ID="txtJobName" runat="server" Width="209px" MaxLength="100"></asp:TextBox>
                <asp:RequiredFieldValidator ID="vldNameRequired" runat="server" ControlToValidate="txtJobName"
                    Display="Dynamic" ErrorMessage="Name is required."></asp:RequiredFieldValidator></td>
        </tr>
        <tr style="color: #000000">
            <td class="formFieldLabel" style="width: 120px;" valign="top">
                Job Description</td>
            <td style="width: 372px;">
                <asp:TextBox ID="txtJobDesc" runat="server" MaxLength="500" Rows="5" TextMode="MultiLine"
                    Width="434px"></asp:TextBox>
            </td>
        </tr>

        <tr>
            <td class="formFieldLabel" style="width: 120px;">
                Deployment Date</td>
            <td style="width: 372px;">
                <ew:CalendarPopup ID="dteDeployDate" runat="server" AllowArbitraryText="False" BackColor="White"
                ...
                <asp:CompareValidator ID="vldDeployDateValid" runat="server" ControlToValidate="dteDeployDate"
                    Display="Dynamic" ErrorMessage="Valid deployment date is required." Operator="DataTypeCheck"
                    Type="Date"></asp:CompareValidator></td>
        </tr>
    </table>
            <asp:TextBox ID="hidJobID" runat="server" Visible="False" Width="10px"></asp:TextBox>
                <asp:TextBox ID="hidFormMode" runat="server" Visible="False" Width="7px"></asp:TextBox>
            </asp:WizardStep>
        </WizardSteps>
