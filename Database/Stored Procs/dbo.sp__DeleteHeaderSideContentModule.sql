...
create       proc sp__DeleteHeaderSideContentModule
...
purpose:
	Delete a header side content module
...
*/
	...
	begin
		if exists(select 1 from tblPageModuleReln_LIVE 
			  where SourceID = @HeaderSideContentModuleID
			  and	UPPER(SourceName) = 'HEADER SIDE CONTENT')
		begin
